...
// import { FaBars, FaHome, FaCog, FaFileAlt, FaTh } from 'react-icons/fa';
...
//   return (
//     <div className={`flex flex-col bg-gray-800 text-white h-screen p-4 ${isOpen ? 'w-64' : 'w-20'} transition-width duration-300`}>
...
//       <div className="mt-8">
//         <SidebarItem icon={<FaHome />} text="Home" isOpen={isOpen} onClick={() => onNavItemClick('home')} />
//         <SidebarItem icon={<FaTh />} text="Self Services" isOpen={isOpen} onClick={() => onNavItemClick('self-services')}>
//           <SidebarItem icon={<FaFileAlt />} text="Admission Document" isOpen={isOpen} onClick={() => onNavItemClick('admission-document')} nested />
//         </SidebarItem>
//         <SidebarItem icon={<FaCog />} text="Dashboard" isOpen={isOpen} onClick={() => onNavItemClick('dashboard')} />
//       </div>
//     </div>
//   );
// };
...
// const SidebarItem: React.FC<SidebarItemProps> = ({ icon, text, isOpen, onClick, children, nested = false }) => (
//     <div>
//       <div
//         className={`flex items-center p-2 ${nested ? 'ml-4' : ''} cursor-pointer hover:bg-gray-700`}
//         onClick={onClick}
//       >
//         {icon}
